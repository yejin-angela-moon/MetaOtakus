...
// Import and use the new upload route in your 'server.js' file
...
// create a new route named /user-posts that will fetch the posts from the database and return them as JSON
